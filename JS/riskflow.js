...
(async () => {
  ...
  async function fetchBitgetDashboard() {
    ...
    try {
      ...
      S.balance = equity;
      // DLL: usa walletBalance (saldo realizzato, senza unrealized PnL)
      // così scatta solo quando la perdita è effettivamente chiusa/realizzata
      const walletBalance = equity - upnl;
      S.walletBalance = walletBalance;
      dllCheckBalance(walletBalance); // Daily Loss Limit check — solo perdite realizzate
